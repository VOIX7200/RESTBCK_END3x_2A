...
public class DiscountServiceTest {
	...
	public void tearDown() {
		System.out.println(" TearDown for REST_PROJEA3X_2A In AFTER ");
		//report.flush(); 
	}
	...
	public void we_should_get_ten_percentage_discount() throws InterruptedException {
		...
		try {
			...
			//test.log(Status.FAIL,test.addScreenCaptureFromBase64String(expected),"we should get ten percentage discount");
		//	test.log(null, null);
			//test.log(Status.PASS,"we should get ten percentage discount");
		} 
	}
